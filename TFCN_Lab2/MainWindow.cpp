...
void MainWindow::on_selectComPortButton_clicked()
{
    if(!isConnected)
    {
        ...
        if(com)
        {
            ...
            case 0:
            {
                ...
                ui->FCBCheckBox->setEnabled(true);
                com->resetFinishFlag();
                com->start();
                isConnected = true;
    ...
    }else
    {
        ...
        ui->FCBCheckBox->setEnabled(false);
...
// LAB2
//=============================================================================================================================
void MainWindow::on_FCBCheckBox_stateChanged(int arg)
{
    if(!arg)
        ui->FCBCheckBox->setText("false");
    else
        ui->FCBCheckBox->setText("true");
    PacketManager::setFCB((bool)arg);
}
